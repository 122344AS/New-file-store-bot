...
AUTH_CHANNEL = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('AUTH_CHANNEL', '-1002216593745 -1002141922564 -1002014131153').split()] # give channel id with seperate space. Ex : ('-10073828 -102782829 -1007282828')

API = environ.get("API", "") # shortlink api
URL = environ.get("URL", "") # shortlink domain without https://
VERIFY_TUTORIAL = environ.get("VERIFY_TUTORIAL", "") # how to open link 
BOT_USERNAME = environ.get("BOT_USERNAME", "Erenfilestorebot") # bot username without @
...
PICS = (environ.get('PICS', 'https://graph.org/file/4034ac7482abe37d27ad3.jpg https://graph.org/file/501f7e4e1c479bd4ac85b.jpg https://graph.org/file/1e54ae155d05313fbd908.jpg')).split() # Bot Start Picture
...
class Var(object):
    MULTI_CLIENT = False
    name = str(getenv('name', 'SABotsStreame'))
    ...
    if HAS_SSL:
        URL = "racial-dyann-murshid-47821e45.koyeb.app/"
    else:
        URL = "racial-dyann-murshid-47821e45.koyeb.app/"
